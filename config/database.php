    ...
    */
    ...
    'connections' => [
        ...
        'legacy_sqlite' => [
            ...
            'database' => env('LEGACY_DB_DATABASE', database_path('legacy_database.sqlite')),
            'prefix' => '',
            'foreign_key_constraints' => env('DB_FOREIGN_KEYS', true),
        ],
        'aoe2map_sqlite' => [
            'driver' => 'sqlite',
            'url' => env('AOE2MAP_DATABASE_URL'),
            'database' => env('AOE2MAP_DB_DATABASE', database_path('aoe2map.sqlite')),
            'prefix' => '',
            'foreign_key_constraints' => env('DB_FOREIGN_KEYS', true),
        ],
        'telescope_sqlite' => [
